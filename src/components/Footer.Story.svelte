<script>
	...
	const youtube = () => href && (href.includes("youtube") || href.includes("youtu.be"));
...
<div class="story" style={style()} class:youtube={youtube()} class:resource={resource} class:footer={footer}>
	{#if !resource && !footer}
		<div class="info">
			<p class="id">#{id}</p>
